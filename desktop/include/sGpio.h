...
public:
	...
	uint8_t r8(uint8_t offset);
	int r8(uint8_t offset, uint8_t *data, int length);
	int w8(uint8_t offset, uint8_t data);
	int w8(uint8_t offset, uint8_t *data, int length);
	int r16(uint16_t offset, uint8_t *data, size_t length);
	int w16(uint16_t offset, uint8_t *data, size_t length);
